...
public enum PowerUp {
    ...
    SUB_QUESTS(9, 180, R.string.sub_quests, R.string.power_up_sub_quests_sub_title,
    ...
    NOTES(10, 90, R.string.notes, R.string.power_up_notes_sub_title,
            R.string.power_up_notes_short_desc, R.string.power_up_notes_long_desc, R.drawable.ic_note_white_24dp),

    CUSTOM_DURATION(11, 130, R.string.custom_duration, R.string.power_up_custom_duration_sub_title,
