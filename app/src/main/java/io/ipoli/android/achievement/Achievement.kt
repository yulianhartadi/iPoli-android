...
enum class Achievement(val level : Int = 1) {
    FIRST_QUEST_COMPLETED,
    COMPLETE_10_QUESTS_IN_A_DAY,

    KEEP_PET_HAPPY_5_DAY_STREAK(1),
    KEEP_PET_HAPPY_15_DAY_STREAK(2),
    KEEP_PET_HAPPY_40_DAY_STREAK(3),

    // >= 4
    AWESOMENESS_SCORE_5_DAY_STREAK(1),
    AWESOMENESS_SCORE_20_DAY_STREAK(2),
    AWESOMENESS_SCORE_50_DAY_STREAK(3),

    // only on plan days
    FOCUS_HOURS_5_DAY_STREAK(1),
    FOCUS_HOURS_20_DAY_STREAK(2),
    FOCUS_HOURS_50_DAY_STREAK(3),

    PLAN_DAY_5_DAY_STREAK(1),
    PLAN_DAY_20_DAY_STREAK(2),
    PLAN_DAY_50_DAY_STREAK(3),
    ...
    HAVE_1K_LIFE_COINS_IN_INVENTORY(1),
    HAVE_5K_LIFE_COINS_IN_INVENTORY(2),
    HAVE_10K_LIFE_COINS_IN_INVENTORY(3),
    ...
    COMPLETE_DAILY_CHALLENGE(1),
    COMPLETE_DAILY_CHALLENGE_10_DAY_STREAK(2),
    COMPLETE_DAILY_CHALLENGE_30_DAY_STREAK(3),

    COMPLETE_CHALLENGE(1),
    COMPLETE_5_CHALLENGES(2),
    COMPLETE_15_CHALLENGES(3),
