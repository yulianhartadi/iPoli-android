...
public class DailyScheduleTest {
    ...
    public void shouldHaveFreeTimeAtStart() {
        DailySchedule schedule = new DailySchedule(0, 60, 15, Collections.singletonList(new Task(30, 30)));
    ...
    public void shouldHaveFreeTimeAtEnd() {
        DailySchedule schedule = new DailySchedule(0, 60, 15, Collections.singletonList(new Task(0, 30)));
    ...
    public void shouldNotHaveFreeTimeAtSlot() {
        DailySchedule schedule = new DailySchedule(0, 60, 15, Collections.singletonList(new Task(5, 30)));
        assertTrue(schedule.isFree(30, 60));
        assertFalse(schedule.isFree(0, 30));
    }
}