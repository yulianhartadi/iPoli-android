...
enum class AndroidIcon(val icon: IIcon, @ColorRes val color: Int) {
    ...
    WASHING_MACHINE(CommunityMaterial.Icon.cmd_washing_machine, R.color.md_blue_300),
    GAS_STATION(GoogleMaterial.Icon.gmd_local_gas_station, R.color.md_orange_500),
    ...
    APPLE(CommunityMaterial.Icon.cmd_apple, R.color.md_red_500),
    FISH(CommunityMaterial.Icon.cmd_fish, R.color.md_pink_300),
    SMILE(Ionicons.Icon.ion_happy, R.color.md_yellow_600),
    TOOTH(CommunityMaterial.Icon.cmd_tooth, R.color.md_blue_300),
    SMOKE(GoogleMaterial.Icon.gmd_smoking_rooms, R.color.md_purple_300),
    HAND(Ionicons.Icon.ion_android_hand, R.color.md_yellow_600),
    STRETCH(GoogleMaterial.Icon.gmd_accessibility, R.color.md_green_500),
    PAUSE(Ionicons.Icon.ion_ios_pause, R.color.md_pink_300),
    BASKETBALL(Ionicons.Icon.ion_ios_basketball, R.color.md_orange_500),
    ROSE(Ionicons.Icon.ion_ios_rose, R.color.md_red_500),
    SCALE(CommunityMaterial.Icon.cmd_scale_bathroom, R.color.md_green_500),
    EVENT_NOTE(GoogleMaterial.Icon.gmd_event_note, R.color.md_purple_300),
    GLASS_WATER(CommunityMaterial.Icon.cmd_cup_water, R.color.md_blue_300),
    PHOTO_CAMERA(GoogleMaterial.Icon.gmd_camera_alt, R.color.md_orange_500),
}