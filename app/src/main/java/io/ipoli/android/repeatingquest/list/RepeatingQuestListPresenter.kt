 ...
 * on 8/22/17.
 */
class RepeatingQuestListPresenter @Inject constructor(private val displayRepeatingQuestListUseCase: DisplayRepeatingQuestListUseCase) : MviBasePresenter<RepeatingQuestListController, RepeatingQuestListViewState>() {
