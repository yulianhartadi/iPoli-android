...
public interface Constants {
    ...
    String KEY_REMOVED_REPEATING_QUESTS = "REMOVED_REPEATING_QUESTS";
    String KEY_CALENDARS_TO_SYNC = "CALENDARS_TO_SYNC";
    String KEY_SELECTED_ANDROID_CALENDARS = "SELECTED_ANDROID_CALENDARS";
    String KEY_ANDROID_CALENDAR_REPEATING_QUESTS_TO_UPDATE = "ANDROID_CALENDAR_REPEATING_QUESTS_TO_UPDATE";
    String KEY_ANDROID_CALENDAR_QUESTS_TO_UPDATE = "ANDROID_CALENDAR_QUESTS_TO_UPDATE";
