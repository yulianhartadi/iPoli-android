 ...
 * on 02/14/2018.
 */
class CreateQuestsForRepeatingQuestUseCaseSpek : Spek({

    describe("CreateQuestsForRepeatingQuestUseCase") {
        ...
        fun doExecuteUseCase(
            ...
            CreateQuestsForRepeatingQuestUseCase(questRepo, rqRepo).execute(
